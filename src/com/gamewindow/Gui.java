...
//	private static final String SHOW_HELP_LABEL = "Show Help";
//
//	//Rows and Columns of Text area to match the size of the map
//	private static final int MAIN_PANEL_TEXT_AREA_ROWS = 22;
//	private static final int MAIN_PANEL_TEXT_AREA_COLS = 47;
//
//	public static JLabel displayCurrentLocation;
...
//	 * @return
//	 */
//	public JLabel getCurrentItemsPanel() {
//		if(currentItemsPanel == null) {
//			currentItemsPanel = new JPanel();
//			currentItemsPanel.setLayout(new BoxLayout(currentItemsPanel, BoxLayout.PAGE_AXIS));
//
...
//
//	// Font and styling
//	public static final Font titleFont = new Font("Times New Roman", Font.BOLD, 50);
//	public static final Font btnFont = new Font("Times New Roman", Font.BOLD, 10);
//	public static final Font displayAreaFont = new Font("Times New Roman", Font.ITALIC, 18);
//	public static final Font displayNumberFont = new Font("Times New Roman", Font.BOLD, 18);
//	public static final Font itemLabelFont = new Font("Times New Roman", Font.BOLD, 12);
//	// Class to execute to display hidden helpPanel with instructions/commands with
//	// click of help button
//	public class HelpMessageDisplay implements ActionListener {
//		@Override
